...
Lähetä S4 palke perustiedot sapsistilaus
    ...
    Lähetä palke perustiedot sapsistilaus      ${PerustiedotFtpDir}     BUKRS=9500    AUART=9501     FTPDownKeyword=Set SFtp Connection As Up    FTPUpKeyword=Set SFtp Connection As Down

Lähetä S4 kasko perustiedot sapsistilaus
    ${PerustiedotFtpDir}   Get SFTP Dir For     %{KASKO_S4_SFTP_USER_PERUSTIEDOT}
    Lähetä kasko perustiedot sapsistilaus      ${PerustiedotFtpDir}     BUKRS=1400    AUART=1401     FTPDownKeyword=Set SFtp Connection As Up    FTPUpKeyword=Set SFtp Connection As Down

Lähetä S4 sotepe perustiedot sapsistilaus
    ${PerustiedotFtpDir}   Get SFTP Dir For     %{SOTEPE_S4_SFTP_USER_PERUSTIEDOT}
    Lähetä sotepe perustiedot sapsistilaus      ${PerustiedotFtpDir}     BUKRS=3900    AUART=3901     FTPDownKeyword=Set SFtp Connection As Up    FTPUpKeyword=Set SFtp Connection As Down
